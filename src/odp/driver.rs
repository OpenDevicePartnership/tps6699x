...
use embedded_usb_pd::pdo::{sink, source, Common, Contract, Rdo};
...
use type_c_interface::control::vdm::{AttnVdm, OtherVdm, SendVdm, ATTN_VDM_LEN};
...
use crate::command::vdms::{Version, INITIATOR_WAIT_TIME_MS, MAX_NUM_DATA_OBJECTS};
